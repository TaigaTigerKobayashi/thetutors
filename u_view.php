...
<!-- Head[End] -->
<p><a href="student_list2.php">ユーザー一覧へ戻る</a></p>
  ...
  <div class="jumbotron">
   <fieldset>
    <legend>予約情報</legend>
     ...
     <label>受講生徒<input type="text" name="STUDENT_ID" value="<?=$row["STUDENT_ID"]?>"></label><br>
     <label>担当講師<input type="text" name="TUTOR_ID" value="<?=$row["TUTOR_ID"]?>"></label><br>
